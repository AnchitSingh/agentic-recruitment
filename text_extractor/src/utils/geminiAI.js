...
export async function extractJSONFromImages({ imageBlobs, schemaPrompt }) {
  ...
  try {
    ...
    if (error.message.includes('model')) {
      throw new Error('Gemini model unavailable. The model gemma-4-31b-it may not be accessible.');
    }
