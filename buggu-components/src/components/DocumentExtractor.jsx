 ...
 * @param {Object} props.schema - JSON schema for structured output (optional)
...
export function DocumentExtractor({ 
  ...
  const handleExtract = async () => {
    ...
    try {
      ...
      if (schema) {
        // Use custom schema
        extractedData = await geminiService.extractStructuredData({
          items: documentProcessor.getProcessedItems(),
          schema,
          customPrompt,
        ...
        extractedData = await geminiService.extractJobDescription(
          documentProcessor.getProcessedItems(),
          progressCallback
        );
      }
          ...
          >
            {extracting ? (
              ...
              <>
                ...
                {schema ? 'Extract Data' : 'Extract Job Description'}
              </>
            )}
          </button>
        </div>
